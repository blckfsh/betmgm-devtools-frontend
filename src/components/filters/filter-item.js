    ...
    return (
        <>
            <tr>
                ...
                <td scope="row"><span className={brand === "BetMGM" ? "badge badge-warning": brand === "Borgata" ? "badge badge-danger" : brand === "Party Casino" ? "badge badge-info" : brand === "Party Poker" ? "badge badge-success" : "badge badge-dark"}>{brand}</span></td>
